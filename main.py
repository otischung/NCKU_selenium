...
def main():
    ...
    img.show()
    print("Please input captcha result: ", end="")
    captcha = input()

    # 輸入驗證碼
    driver.find_element(By.ID, "code").send_keys(str(captcha))

    # 送出
    driver.find_element(By.CSS_SELECTOR, "#submit_by_acpw > span").click()
